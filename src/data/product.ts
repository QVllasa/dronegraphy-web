import type {PopularProductsQueryOptions, Product, ProductPaginator, ProductQueryOptions,} from '@/types';
...
export function useProducts(options?: Partial<ProductQueryOptions>, config?: UseInfiniteQueryOptions<ProductPaginator, Error>) {
...
export function usePopularProducts(options?: Partial<PopularProductsQueryOptions>) {
    const {locale} = useRouter();
